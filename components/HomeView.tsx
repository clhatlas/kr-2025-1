    ...
    <div className="p-4 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-white p-5 rounded-lg border border-slate-300 relative overflow-hidden group shadow-sm">
        ...
        <div className="flex justify-between items-start mb-4">
            <div>
                <h2 className="text-xl font-extrabold text-slate-900 tracking-tight uppercase">行程儀表板</h2>
                <p className="text-cyan-600 text-xs font-mono tracking-wider">狀態：進行中 // 第 {new Date().getDate() > 16 && new Date().getDate() < 22 ? new Date().getDate() - 16 : '預備'} 天</p>
            </div>
        ...
        <div className="flex items-center gap-4 relative z-10">
            <div className="flex-1 bg-slate-50 border border-slate-200 p-3 rounded">
                <div className="text-[10px] text-slate-500 font-bold uppercase mb-1 font-mono">完成度</div>
            ...
            >
                ...
                <span className="text-[8px] font-mono mt-1 font-bold">開始</span>
            </button>
        </div>
      </div>
                 ...
                 <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-md border border-slate-900 p-0 rounded shadow-2xl animate-in slide-in-from-bottom-2 z-[1000] overflow-hidden">
                    <div className="px-4 py-2 flex justify-between items-center" style={{ backgroundColor: DAY_COLORS[selectedActivity.day] }}>
                         <span className="text-[10px] font-bold text-white font-mono uppercase">
                                區域：第 {selectedActivity.day} 天
                        </span>
                        <button onClick={() => setSelectedActivity(null)} className="text-white/80 hover:text-white font-mono text-xs">[關閉]</button>
                    </div>
                    <div className="p-4">
                ...
                >
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                            ...
                            <span className="text-[10px] text-slate-400 font-mono"> // {day.activities.length} 項活動</span>
                        </div>
                    </div>
